    ...
    <div class="col-md-6">
        <div class="card h-100">
            <div class="card-body">
                ...
                @php($config = \App\CPU\Helpers::get_business_settings('PayUmoney'))
                <form action="{{ route('admin.business-settings.payment-method.update', ['PayUmoney']) }}" method="post">
                    @csrf
                    @if (isset($config))
                        <center class="mb-3">

                            <img style="background-color: #afc61f"
                                src="{{ asset('public/assets/front-end/img/PayUmoney_logo.png') }}" />

                        </center>

                        <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                            <h5 class="text-uppercase">{{ \App\CPU\translate('PayUmoney') }}</h5>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-example-responsive form-control" name="environment">
                                <option value="test" {{ $config['environment'] == 'sandbox' ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('PayUmoney_merchant_key') }}</label>
                            <input type="text" class="form-control" name="PayUmoney_merchant_key"
                                value="{{ env('APP_MODE') != 'demo' ? $config['PayUmoney_merchant_key'] : '' }}">
                        </div>

                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('PayUmoney_merchant_mid') }}</label>
                            <input type="text" class="form-control" name="PayUmoney_merchant_mid"
                                value="{{ env('APP_MODE') != 'demo' ? $config['PayUmoney_merchant_mid'] : '' }}">
                        </div>

                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('PayUmoney_merchant_website') }}</label>
                            <input type="text" class="form-control" name="PayUmoney_merchant_website"
                                value="{{ env('APP_MODE') != 'demo' ? $config['PayUmoney_merchant_website'] : '' }}">
                        </div>
