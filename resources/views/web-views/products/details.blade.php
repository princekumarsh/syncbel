                            ...
                            <div class="single-product-content">
                                <div class="inner">
                                    ...
                                    <form id="add-to-cart-form" class="mb-2">
                                                ...
                                                <div>
                                                    <ul class="list-inline checkbox-alphanumeric checkbox-alphanumeric--style-1 mb-2 mx-1 flex-start"
                                                        ...
                                                        @foreach ($choice->options as $key => $option)
                                                                ...
                                                                <li class="for-mobile-capacity" style="margin:2px;">
                                                                    <input type="radio"
                                                                        id="{{ $choice->name }}-{{ $option }}"
                                                                        name="{{ $choice->name }}"
                                                                        value="{{ $option }}"
                                                                        @if ($key == 0) checked @endif>
                                                                    <label style="padding:2px;" class="__text-12px type_design"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center __w-160px"
                                                        ...
                                                        <span class="input-group-btn">
                                                            <button class="btn btn-number __p-10 minus" type="button"
                                        ...
                                        <div class="only-desk-view">
                                            <div class="d-flex justify-content-between">
                                                <button
                                                    class="axil-btn btn-buy  btn-gap-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}"
                                                ...
                                                <button
                                                    ...
                                                    onclick="addToCart(); window.location.reload(true);" type="button">
                                                    <span class="string-limit">{{ \App\CPU\translate('add_to_cart') }}</span>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="only-desk-view" style="margin-top: 10px;">
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <div class="product-variation quantity-variant-wrapper">
                                        ...
                                        <div class="pro-qty"></span><input type="text" value="1"></span></div>
                                    </div>
                                    {{-- buy now --}}
                                    <div class="only-desk-view">
                                        <div class="d-flex justify-content-between">
                                            <button class="btn-buy axil-btn btn-gap-right" onclick="buy_now()" type="button">
                                                <span class="string-limit" style="color:white;">Buy now</span>
                                            </button>
                                            <button class="axil-btn btn-bg-primary btn-gap-right" style="margin-left: 2%;" onclick="addToCart()" type="button">
                                                <span class="string-limit">Add to cart</span>
                                            </button>
                                            <button class="wishlist" style="margin-left: 2%; width:300px;" onclick="addWishlist('{{ $product['id'] }}" type="button">
                                                <span class="string-limit"><i class="far fa-heart"></i></span>
                                            </button>
                                            <button class="wishlist" style="margin-left: 2%; width:300px;" onclick="wishlist()" type="button">
                                                <span class="string-limit"><i class="fa fa-share" aria-hidden="true" style="font-size: 18px;"></i></span>
                                            </button>
                                        </div>
                                    </div>
    ...
    <div style="position:fixed;z-index:2;background-color:#ff497c;bottom:0;width: 100%;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" class="fixed-sm-size">
        <div class="d-flex justify-content-between">
            <button
                ...
                onclick="buy_now()" type="button" style="background-color:#ff497c;">
                <span class="string-limit" style="color:white;">{{ \App\CPU\translate('buy_now') }}</span>
            </button>
            <button
                class="axil-btn btn-bg-primary btn-gap-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}" style="margin-left: 2%;"
