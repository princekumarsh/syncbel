...
<div class="steps steps-light pt-2 pb-2 d-flex justify-content-between">
    <a class="step-item {{$step>=1?'active':''}} {{$step==1?'current':''}}" href="{{route('checkout-details')}}">
        <div class="step-progress">
            <span class="step-count"><i class="fa fa-user-circle" style="font-size: 16px"></i></span>
        </div>
    ...
    <a class="step-item {{$step>=2?'active':''}} {{$step==2?'current':''}}" href="{{route('checkout-details')}}">
        <div class="step-progress">
            <span class="step-count"><i class="fas fa-shipping-fast"></i></span>
        </div>
    ...
    <a class="step-item {{$step>=3?'active':''}} {{$step==3?'current':''}}" href="{{route('checkout-payment')}}">
        <div class="step-progress">
            <span class="step-count"><i class="fa fa-credit-card"></i></span>
        </div>
        <div class="step-label">
