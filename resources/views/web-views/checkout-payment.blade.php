                ...
                <!-- Payment methods accordion-->
                        ...
                        @if ($digital_payment['status']==1)
                            ...
                            @if(isset($config) && $config['status'])
                                <div class="col-sm-6">
                                    <div class="card cursor-pointer">
                                        <div class="card-body pt-2 __h-100px">
                                            <form method="POST" action="{{ route('pay.u.money') }}">
                                                {{ csrf_field() }}

                                                <button class="btn btn-block click-if-alone " style="background-color: #afc61f" type="submit">
                                                    <img width="200" alt="PayUmoney logo" title="PayUmoney"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 text-center mt-5">
                            <a class="btn btn-lg btn-secondary btn-block" href="{{route('checkout-details')}}">
