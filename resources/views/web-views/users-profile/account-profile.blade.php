...
@section('content')
    ...
    <div class="container rtl">
        <h3 class="py-3 m-0 text-center headerTitle">{{\App\CPU\translate('account_details')}}</h3>
    </div>
    <!-- Page Content-->
                ...
                <div class="tab-pane fade active show" id="nav-account" role="tabpanel">
                    <div class="col-lg-9" >
                        <div class="axil-dashboard-account" >
                            ...
                            <form class="account-details-form" action="{{route('user-update')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="axil-dashboard-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <img id="blah" style="width: 70px;"
                                            class="rounded-circle border __inline-48"
                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                            src="{{asset('storage/app/public/profile')}}/{{$customerDetail['image']}}">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="title mb-0">Hello {{$customerDetail->f_name}}</h5>
                                            <label for="files" class="lhov"><span class="joining-date">Change your profile pic</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb--40">
                                            <label for="inputEmail4" class="blable">{{\App\CPU\translate('Email')}} </label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb--40">
                                            ...
                                            <input type="number" class="form-control blable" type="text" id="phone"
                                                   name="phone"
                ...
                <div class="card box-shadow-sm">
                    <div class="card-header">
                        <form class="mt-3 px-sm-2 pb-2" action="{{route('user-update')}}" method="post"
                            ...
                            <div class="row photoHeader g-3" style="margin-left: 10px;margin-right: 10px;">
                                @csrf
                                <div class="d-flex mb-3 mb-md-0 align-items-center">
                                    ...
                                    <div class="{{Session::get('direction') === "rtl" ? 'pr-2' : 'pl-2'}}" style="margin-left:18px;">
                                ...
                                <div class="card-body mt-md-3 p-0">
                                    <h3 class="font-name " >{{\App\CPU\translate('account_information')}} </h3>
                                    {{-- <div class="row">
                                        <div class="col-6"></div>
                                        <div class="col-6">kjkk</div>
                                    </div> --}}
                                    <div class="row" style="margin-top: 4px;">
                                        <div class="form-group col-6 mb-0 mt-4">
                                            <label for="firstName" class="blable">{{\App\CPU\translate('first_name')}} </label>
                                            <input type="text" class="form-control " id="f_name" name="f_name"
                                                   value="{{$customerDetail['f_name']}}" required>
                                        </div>
                                        <div class="form-group col-6 mb-0 mt-4">
                                            <label for="lastName" class="blable"> {{\App\CPU\translate('last_name')}} </label>
                                            <input type="text" class="form-control" id="l_name" name="l_name"
                                                   value="{{$customerDetail['l_name']}}">
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 4px;">
                                        ...
                                        <div class="form-group col-md-6 mb-0 mt-4">
                                            <label for="phone" class="blable">{{\App\CPU\translate('phone_number')}} </label>
                                    ...
                                    <div class="row" style="margin-top: 4px;">
                                        <div class="form-group col-md-6 mb-0 mt-4" >
                                            <label for="si-password" class="blable">{{\App\CPU\translate('new_password')}}</label>
                                        ...
                                        <div class="form-group col-md-6 mb-0 mt-4">
                                            <label for="newPass" class="blable">{{\App\CPU\translate('confirm_password')}} </label>
                                            <div class="password-toggle">
                                        ...
                                        <div class="col-12 d-flex flex-wrap justify-content-between __gap-15 __profile-btns mt-4">
                                             ...
                                             <a class=" " >
                                                 <button type="submit" class="bg-success btn btn-lg w-100 text-light">{{\App\CPU\translate('update')}}   </button>
                                             </a>
