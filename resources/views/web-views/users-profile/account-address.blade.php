...
@section('content')
    <div class="__account-address">
        ...
        <div class="container pb-5 mb-2 rtl">
            <h3 class="py-3 text-center headerTitle"
                        ...
                        <!-- Content  -->
                            <section class="col-lg-9 col-md-9">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    <button  style="width:170px;font-size:18px;" class="btn btn-lg btn-primary" onclick="window.location.href='{{route('add_address')}}'" id="add_new_address">{{\App\CPU\translate('add_new_address')}}
                                    </button>
                                </div>
                                            ...
                                            <div class="card __shadow h-100">
                                                <div class="card-header d-flex justify-content-between d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                            <a class="" title="Edit Address" id="edit" href="{{route('address-edit',$shippingAddress->id)}}" style="margin-right: 5px;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div><span class="font-nameA"> <strong> {{\App\CPU\translate('state')}} :</strong> {{$shippingAddress['state']}}</span>
                                                    </div>
            ...
            <!-- Content  -->
                <section class="col-lg-9 col-md-9">
                    ...
                    <!-- Addresses list-->
                    <div class="d-flex justify-content-end mb-3">
                        <button type="submit" style="width:170px;font-size:18px;" class="btn btn-lg btn-primary" data-toggle="modal"
