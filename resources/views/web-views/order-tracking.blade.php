        ...
        <div class="btn--primary">
            <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
                ...
                <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
                    <h4 class=" mb-0">{{ \App\CPU\translate('Order ID')}} : <span
                            class="h4 font-weight-normal ">{{$orderDetails['id']}}</span></h4>
                </div>
            </div>
        </div>
                ...
                <div class="pt-2 pb-2 text-center rounded-lg">
                    <span class="font-weight-medium text-dark mr-2 ">{{ \App\CPU\translate('Order Status')}}:</span><br>
                        ...
                        @if($orderDetails['order_status'] =='pending')
                            <span class="text-uppercase badge badge-warning">{{ \App\CPU\translate('pending')}} </span>
                        @elseif($orderDetails['order_status'] =='processing')
                            <span class="text-uppercase badge badge-secondary">{{ \App\CPU\translate('Processing')}}</span>
                        @elseif($orderDetails['order_status'] =='confirmed')
                            <span class="text-uppercase badge badge-info">{{ \App\CPU\translate('confirmed')}}</span>
                        @elseif($orderDetails['order_status'] =='failed')
                            <span class="text-uppercase badge badge-danger">{{ \App\CPU\translate('failed')}}</span>
                        @elseif($orderDetails['order_status'] =='cancelled')
                            <span class="text-uppercase badge badge-danger">{{ \App\CPU\translate('cancelled')}}</span>
                        @elseif($orderDetails['order_status'] =='delivered')
                            <span class="text-uppercase badge badge-success">{{ \App\CPU\translate('delivered')}}</span>
                        @else
            ...
            <div class="col-sm-4">
                <div class="pt-2 pb-2 text-center rounded-lg">
                    ...
                    @if($orderDetails['payment_status'] =='paid')
                        <span class="text-uppercase badge badge-success">{{ \App\CPU\translate('paid')}}</span>
                    @else
                        <span class="text-uppercase badge badge-danger">{{ \App\CPU\translate('Unpaid')}}</span>
                    @endif
                </div>
            </div>
            <div class="col-sm-4">
