...
@section('content')
                    ...
                    @if ($physical_product_view)
                        ...
                        <form method="post" class="card " id="address-form">
                            @foreach ($shipping_addresses as $key => $address)
                                <div class="axil-checkout-login toggle-open address_clicl" onclick="$('#sh-{{ $address['id'] }}').prop( 'checked', true )" style="display: block; margin: 7px 20px ;">
                                    {{-- <input type="radio" name="shipping_method_id" id="sh-{{ $address['id'] }}"
                                                value="{{ $address['id'] }}" {{ $key == 0 ? 'checked' : '' }}> --}}
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="shipping_method_id" id="sh-{{ $address['id'] }}" value="{{ $address['id'] }}" {{ $key == 0 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            {{ $address['address_type'] }}
                                            <span style="margin-left:25px;"><i class="fa fa-phone"></i></span>
                                            <b>+91 {{ $address['phone'] }}</b>
                                        </label>
                                    </div>

                                    <div style="margin-left: 53px;">
                                        <p>Name: <b>{{ $address['contact_person_name'] }}</b>
                                            <br>
                                            Address : <b>{{ $address['address'] }},
                                                        {{ $address['city'] }}, {{ $address['zip'] }}.</b>
                                        </p>
                                    </div>
                                    {{-- <div class=" mb-0">
                            ...
                            <div class="list-group-item" onclick="anotherAddress()">
                                <input type="radio" name="shipping_method_id" class="add_new_address" id="sh-0"
                                    value="0" data-toggle="collapse" data-target="#collapseThree"
                                    {{ $shipping_addresses->count() == 0 ? 'checked' : '' }}>
                                <span class="checkmark add_new_address"
                                    style="margin-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}: 10px"></span>

                                <button type="button" class="btn btn-outline btn-sm add_new_address" data-toggle="collapse"
                                    style="width: 147px;height: 36px;background: #000; font-size: 16px; border-radius:16px;color:white;"
                                ...
                                <div id="accordion" class="hidden_new_address" style="margin-top: 6px;">
                                    <div id="collapseThree" class="collapse " aria-labelledby="headingThree"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!--            <input type="text" name="name" id="first-name" placeholder="Adam">-->
                                            <!--        </div>-->
                                            <!--    </div>-->
                                            <!--    <div class="col-lg-6 col-sm-6">-->
                                            <!--        <div class="form-group">-->
                                            <!--            <label>Phone <span>*</span></label>-->
                                            <!--            <input type="tel" id="phone" name="phone" placeholder="+91 8882279037">-->
                                            <!--        </div>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                                ...
                                                <div class="col-lg-6 col-sm-6">
                                                    <div class="form-group ">
                                                        <label for="exampleInputEmail1"
                                                            class="blable">{{ \App\CPU\translate('full_name') }}
                                                ...
                                                <div class="col-lg-6 col-sm-6">
                                                    <div class="form-group">
                                                        <input type="hidden" class="form-control" name="country"
                                                            value="India">
                                                        <label class="blable"
                                                            for="exampleInputEmail1">{{ \App\CPU\translate('State') }}
                        ...
                        <!-- <form method="post" class="card " id="address-form">
                                <div class="card-body p-0">
                                    <ul class="list-group">
                                        @foreach ($shipping_addresses as $key => $address)
    <li class="list-group-item __inline-57 address_clicl"
                                                onclick="$('#sh-{{ $address['id'] }}').prop( 'checked', true )">
                                                <input type="radio" name="shipping_method_id" id="sh-{{ $address['id'] }}"
                                                    value="{{ $address['id'] }}" {{ $key == 0 ? 'checked' : '' }}>
                                                <span class="checkmark address_clicl"
                                                    style="margin-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}: 10px"></span>
                                                <label class="badge address_clicl"
    ...
    @endforeach
                                        {{-- insert code here for another address  --}}
                                        <li class="list-group-item" onclick="anotherAddress()">
                                            <input type="radio" name="shipping_method_id" class="add_new_address"
                                            ...
                                            <button type="button" class="btn btn-outline btn-sm add_new_address"
                                                data-toggle="collapse"
                                                style="width: 137px;height: 42px;background: #ff497c; font-size: 16px;"
                                                data-target="#collapseThree">{{ \App\CPU\translate('Another') }}
                                                {{ \App\CPU\translate('address') }}
                                            </button>
                                            <div id="accordion" class="hidden_new_address">
                                                <div id="collapseThree" class="collapse " aria-labelledby="headingThree"
                                                    data-parent="#accordion">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="exampleInputEmail1">{{ \App\CPU\translate('full_name') }}
                                                                        <span class="text-danger">*</span></label>
...
@else
    ...
    @endforelse
                                                        ...
                                                        <div class="form-check"
                                                            style="padding-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}: 1.25rem; display:none;">
                                                            <input type="checkbox"  name="save_address"
                                                                class="form-check-input save_address_new"  id="exampleCheck1">
                                            ...
                                            <div id="billing_model"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label for="exampleInputEmail1">{{ \App\CPU\translate('State') }}
                                                            <span style="color: red">*</span></label>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-3">
                            <a class="btn btn-lg btn-primary btn-block" href="javascript:" onclick="proceed_to_next()"
                                style="font-size:18px;">
                                <span class="d-none d-sm-inline">{{ \App\CPU\translate('proceed_to_payment') }}</span>
...
@push('script')
    ...
    <script>
        ...
        $(".address_clicl").click(function() {

            $(".hidden_new_address").hide();
            $('input[name=save_address]').attr('checked', false);
        });
        $(".add_new_address").click(function() {
            // alert('njjj');
            $(".hidden_new_address").show();
