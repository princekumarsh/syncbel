                            ...
                            <div class="card-body p-0">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item" onclick="anotherAddress()">
                                        ...
                                        <button type="button" class="btn btn-outline mb-4" data-toggle="collapse"
                                            ...
                                            <div id="collapseThree"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="address_type" style="font-size: 15px;">
                                                            <option
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="country" id="" class="form-control" style="font-size:15px" required>
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-check" style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 2.25rem;">
                    ...
                    <div style="display: {{$billing_input_by_customer?'':'none'}}">
                        ...
                        @if($physical_product_view)
                            <div class="form-check mb-2"
                                ...
                                <input type="checkbox" style="margin-right: 36px;" id="same_as_shipping_address" onclick="hide_billingAddress()"
...
{{--                                        {{$billing_addresses->count()==0?'checked':''}}--}}
                                            ...
                                            <div id="billing_model"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputPassword1">{{ \App\CPU\translate('address')}} {{ \App\CPU\translate('Type')}}</label>
                                                        <select style="font-size: 15px;" class="form-control" name="billing_address_type">
                                                            <option
                                                                value="permanent">{{ \App\CPU\translate('Permanent')}}</option>
                                                            <option value="home">{{ \App\CPU\translate('Home')}}</option>
                                                            <option
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="billing_country" id="" class="form-control" style="font-size: 15px;">
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            <a class="btn btn-info btn-block w-100" href="{{route('shop-cart')}}">
                                <i class="fa fa-arrow-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} mt-sm-0 mx-1"></i>
                                <span class="d-none d-sm-inline" style="font-size:16px">{{ \App\CPU\translate('shop_cart')}}</span>
                                <span class="d-inline d-sm-none">{{ \App\CPU\translate('shop_cart')}}</span>
                            </a>
                        </div>
                        <div class="col-6">
                            <a class="btn btn-primary w-100 btn-block" href="javascript:" onclick="proceed_to_next()">
                                <span class="d-none d-sm-inline" style="font-size:16px">{{ \App\CPU\translate('proceed_payment')}}</span>
                                <span class="d-inline d-sm-none">{{ \App\CPU\translate('Next')}}</span>
                                <i class="fa fa-arrow-{{Session::get('direction') === "rtl" ? 'left' : 'right'}} mt-sm-0 mx-1"></i>
                            </a>
                        </div>
                    </div>
                    <!-- Sidebar-->
