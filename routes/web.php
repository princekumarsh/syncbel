...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('/shopl-page','WebController@shoplist')->name('webView.shop');
    Route::get('/singleProduct/{id}','WebController@singleProduct')->name('webView.singleproduct');
    Route::get('/cartlist','WebController@cartlist')->name('webView.cart');
    Route::get('/checkoutProduct','WebController@checkoutPro')->name('webView.checkout');
    Route::get('/contact','WebController@contactNav')->name('contact');
    Route::get('/about','WebController@aboutNav')->name('about');
    ...
    Route::get('password', 'UserProfileController@password')->name('password');
    ...
    Route::get('add-address', 'UserProfileController@add_address')->name('add_address');
    ...
    Route::get('add-ticket', 'UserProfileController@ticket_add')->name('addticket');
...
/*paypal*/
//payU money
Route::post('pay-u-money-view', 'PayUMoneyController@payUMoneyView')->name('pay.u.money');
Route::post('pay-u-response', 'PayUMoneyController@payUResponse')->name('pay.u.response');
Route::post('pay-u-cancel', 'PayUMoneyController@payUCancel')->name('pay.u.cancel');
