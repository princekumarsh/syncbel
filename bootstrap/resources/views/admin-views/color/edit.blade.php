            ...
            <div class="col-md-12 mb-10">
                <div class="card">
                    <div class="card-body"
                        ...
                        <form action="{{route('admin.color.update',[$attribute['id']])}}" method="post">
                            @csrf
                            ...
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                     id="{{$lang}}-form">
                                    <input type="hidden" id="id">
                                    <label class="title-color" for="code">{{ \App\CPU\translate('Color')}} {{ \App\CPU\translate('Code')}}
                                        ({{strtoupper($lang)}})</label>
                                    <input type="text" name="code"
                                           value="{{$lang==$default_lang?$attribute['code']:($translate[$lang]['code']??'')}}"
                                           class="form-control" id="name"
