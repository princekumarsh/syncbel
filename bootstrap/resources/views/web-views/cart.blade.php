                    ...
                    <div class="row w-100 mt-5">
                                ...
                                <table class="table axil-product-table axil-cart-table mb--40">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product-thumbnail"><a href="single-product.html"><img src="{{asset('/storage/app/public/product/thumbnail/holder.jpg')}}" alt="Digital Product"></a></td>
                                        ...
                                        <tr>
                                            <td class="product-remove"><a href="#" class="remove-wishlist"><i class="fal fa-times"></i></a></td>
                                            <td class="product-thumbnail"><a href="single-product-2.html"><img src="{{asset('/storage/app/public/product/thumbnail/holder.jpg')}}" alt="Digital Product"></a></td>
                                        ...
                                        <tr>
                                            <td class="product-remove"><a href="#" class="remove-wishlist"><i class="fal fa-times"></i></a></td>
                                            <td class="product-thumbnail"><a href="single-product-3.html"><img src="{{asset('/storage/app/public/product/thumbnail/holder.jpg')}}" alt="Digital Product"></a></td>
                        ...
                        <div class="col-lg-5">
                            <div class="axil-order-summery">
                                ...
                                <a href="{{route('webView.checkout')}}" class="axil-btn btn-bg-primary checkout-btn">Process to Checkout</a>
                            </div>
                        </div>
                    </div>

                    <div class="cart-update-btn-area mt-5">
