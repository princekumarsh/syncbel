                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="inner">
                            <div class="bradcrumb-thumb">
                                <img src="{{asset('/storage/app/public/product/thumbnail/holder.jpg')}}" alt="Image" style="width:90px;height:90px;border-radius:50%" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="about-thumbnail">
                            <div class="thumbnail">
                                <img src="{{asset('/storage/app/public/product/thumbnail/holder.jpg')}}" alt="About Us">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row--20">
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="{{asset('public/assets/front-end/assets/images/about/shape-01.png')}}" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="{{asset('public/assets/front-end/assets/images/about/shape-02.png')}}" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="{{asset('public/assets/front-end/assets/images/about/shape-03.png')}}" alt="Shape">
                            </div>
                            <div class="content">
        ...
        <div class="axil-about-area about-style-2">
            <div class="container">
                <div class="row align-items-center mb--80 mb_sm--60">
                    <div class="col-lg-5">
                        <div class="about-thumbnail">
                            <img src="{{asset('/storage/app/public/product/thumbnail/holder.jpg')}}" alt="about">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="about-content content-right">
