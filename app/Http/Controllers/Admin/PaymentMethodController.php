...
class PaymentMethodController extends Controller
{
    ...
    public function update(Request $request, $name)
    {
        ...
        } elseif ($name == 'PayUmoney') {
            DB::table('business_settings')->updateOrInsert(['type' => 'PayUmoney'], [
                'value' => json_encode([
                    'status' => $request['status'],
                    'environment' => $request['environment'],
                    'PayUmoney_merchant_key' => $request['PayUmoney_merchant_key'],
                    'PayUmoney_merchant_mid' => $request['PayUmoney_merchant_mid'],
                    'PayUmoney_merchant_website' => $request['PayUmoney_merchant_website'],
                    'PayUmoney_refund_url' => $request['PayUmoney_refund_url'],
                ]),
                'updated_at' => now()
            ]);
        }
