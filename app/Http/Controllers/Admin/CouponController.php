...
class CouponController extends Controller
{
    ...
    {   //dd($request->all());
       ...
       $coupon->save();
         $message = '';
        if ($request->coupon_type == 'first_order' || $request->customer_id == '0') {
            $customers = User::where('is_active','1')->get();
            $message = '& Send mail all user';
            ...
            foreach($customers as $customer){
                ...
                Mail::to($customer['email'])->send(new \App\Mail\Coupon($body));
            }
        ...
        if($request->customer_id > 0){
            ...
            $customer = User::where('id', $request->customer_id)->first();
                ...
                $message = "& Send mail $customer->f_name  $customer->l_name";
                Mail::to($customer['email'])->send(new \App\Mail\Coupon($body));
        ...
        Toastr::success("Coupon added successfully $message !");
        return back();
    }
