...
class UserProfileController extends Controller
{
    ...
    public function password(Request $request){
        ...
        return view('web-views.users-profile.password');
    }
    ...
    public function add_address(){
        ...
        if (auth('customer')->check()) {
            $shippingAddresses = \App\Model\ShippingAddress::where('customer_id', auth('customer')->id())->get();
            return view('web-views.users-profile.addaddress', compact('shippingAddresses', 'country_restrict_status', 'zip_restrict_status', 'data', 'zip_codes'));
        } else {
            return redirect()->route('home');
        }
    }
    ...
    public function address_store(Request $request)
    {
        ...
        Toastr::success(translate('address added successfully'));
    ...
    public function address_delete(Request $request)
    {
        if (auth('customer')->check()) {
            ...
            Toastr::warning(translate('Address deleted successfully'));
            return redirect()->back();
        } else {
            return redirect()->back();
        }
    ...
    {
        $orders = Order::with(['details.product'])->where('customer_id', auth('customer')->id())->orderBy('id','DESC')->paginate(15);
        // dd($orders);
    ...
    public function ticket_add(){
        return view('web-views.users-profile.account-add-tickets');
    }
    ...
    public function ticket_submit(Request $request)
    {
        ...
        Toastr::success(translate('Ticket added successfully'));
